...
// Fundo "Dither" (reactbits.dev/backgrounds/dither, componente gratuito):
// duas passadas de WebGL sobre um plano em tela cheia. A primeira desenha
// ondas orgânicas (Perlin/fbm) que reagem ao mouse; a segunda é um pós-
// processamento que quantiza as cores e aplica dithering ordenado (matriz de
// Bayer 8x8), dando o visual retrô "pixelado em poucas cores".
