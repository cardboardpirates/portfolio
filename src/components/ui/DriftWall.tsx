// Componente de terceiros (React Bits, https://reactbits.dev/components/drift-wall),
// adaptado para este projeto: parede infinita de azulejos em perspectiva 3D que
// "derivam" (drift) verticalmente em colunas com velocidades levemente diferentes,
// e sobem (lift) ao passar o mouse ou focar. Vendorizado direto (TS + Tailwind,
// sem dependências externas além do React) em vez de instalado via CLI porque
// o projeto não usa shadcn/jsrepo.
//
// Único ajuste feito na cópia original: "CSSProperties" virou um import de tipo
// explícito ("import type"), exigido pelo "verbatimModuleSyntax" do tsconfig
// deste projeto.
